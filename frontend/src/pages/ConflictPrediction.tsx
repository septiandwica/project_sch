...
import { AlertTriangle, Download, CheckCircle, Target } from 'lucide-react';
    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center space-x-3 mb-4">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Train machine learning models to detect and prevent scheduling conflicts
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm border border-gray-200 dark:border-gray-700">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                ...
                <button
                  onClick={() => downloadFile(result.model_file)}
      ...
      <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-lg p-6">
        ...
        <ul className="text-sm text-orange-800 dark:text-orange-400 space-y-1">
          <li>• <strong>Training File:</strong> Must contain "Room" and "Sched. Time" columns</li>
          <li>• The model will automatically detect conflicts in your schedule data</li>
          <li>• Higher accuracy indicates better conflict detection capability</li>
          <li>• Use the generated model file for future conflict predictions</li>
        </ul>
      </div>
    </div>
  );
